...
from price_monitor import candle_store, decision_log, health, tremor_delivery, weekly_digest
...
def main() -> int:
    ...
    # The Tremor side: pushes as they come, and the Tuesday/Friday digest. Also
    # on the hourly trigger, and a no-op while cfg.tremor_alerts_muted is set,
    ...
    try:
        tremor_delivery.maybe_deliver(cfg, state)
