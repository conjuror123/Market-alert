...
from tremor import features, forecast, threshold, windows

log = logging.getLogger("tremor.detector")

DEFAULT_SCORES_PATH = os.path.join("data", "tremor", "detector_scores.parquet")
DEFAULT_ALERTS_PATH = os.path.join("data", "tremor", "detector_alerts.parquet")
