...
Архив экономических событий собирается из двух источников без ключей: датасет
«Global Economic Calendar» на Kaggle (2021 — октябрь 2025, лицензия
CC BY-NC-SA 4.0) и помесячные страницы ForexFactory дальше. Живой недельный фид
продолжает пополнять его вперёд при каждом субботнем дайджесте. Подробности
замены и почему прежние три дампа выброшены — в `docs/meals-otstupleniya.md`.
