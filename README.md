...
Суммарно по всем 9 активам — около **2.2 уведомления в неделю**: это и есть
осознанная цель, а не побочный эффект. Более ранняя версия порогов была настроена
на противоположную задачу — не пропустить вообще ничего крупного — и в реальном
использовании оказалась слишком шумной, около 22 уведомлений в неделю суммарно.
Текущие пороги пересчитаны бэктестом заново под другую цель: 0-1 уведомление в
неделю суммарно в спокойное время, 2-3 — в самые турбулентные периоды.

Recall здесь — это доля из 5 крупнейших часовых движений каждого актива за год,
которые бот реально бы поймал; итог — **27 из 45**. При настройке на редкие
