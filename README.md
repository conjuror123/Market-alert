...
Проект полностью написан через vibe-coding в Claude. Автор старался следить за
читабельностью этого README, но если хочется быстро разобраться в деталях — тоже
стоит воспользоваться ИИ.
...
Суммарно по 10 активам — около **2.4 уведомления в неделю**, это осознанная цель.
Более ранняя версия порогов (9 активов, до DXY) была настроена на противоположное —
не пропустить вообще ничего крупного — и на практике давала около 22 уведомлений в
неделю, что оказалось чрезмерно шумным. Текущие пороги пересчитаны под 0-1/неделю в
спокойное время и 2-3 в турбулентное; новый актив слегка поднимает эту сумму —
баланс числа активов и частоты на ваше усмотрение.

Recall — доля из 5 крупнейших часовых движений каждого актива за год, которые бот
реально поймал бы: итог **31 из 50**. При настройке на редкие уведомления recall
ниже, чем при настройке на максимальный охват — это следствие выбранной цели, а не
недосмотр. Большая часть «пропусков» — не потерянный сигнал, а работа паузы между
уведомлениями: несколько скачков подряд в одном турбулентном эпизоде схлопываются в
одно уведомление, и бэктест засчитывает «пропуском» те, что не стали первым в
серии.
